...
// TODO: Pull these out into utilities
const s4 = () => {
...
// TODO: replace Object.assign with extend via xtend
function reducer(state = initialState, action) {
  ...
  switch (type) {
    ...
    case SHOW_LAYERS_NOT_VISIBLE_FOR_SCALE: {
    ...
    case SET_INITIAL_LEGEND_MAPIMAGELAYER_DATA: {
    ...
    case SET_INITIAL_LEGEND_GRAPHICSLAYER_DATA: {
